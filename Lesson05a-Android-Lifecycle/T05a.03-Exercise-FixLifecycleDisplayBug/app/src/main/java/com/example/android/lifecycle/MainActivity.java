...
public class MainActivity extends AppCompatActivity {
    ...
    private static List<String> sLifecycleCallbacks = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = sLifecycleCallbacks.size() - 1; i >= 0; i--) {
    ...
    protected void onStop() {
        ...
        sLifecycleCallbacks.add(0, ON_STOP);
    ...
    protected void onDestroy() {
        ...
        sLifecycleCallbacks.add(0, ON_DESTROY);
